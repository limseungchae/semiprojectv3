    ...
    <header class="row">
        ...
        <div class="col text-end">
            <button type="button" class="btn btn-danger  mt-2"
                    data-bs-target="#loginfrm" data-bs-toggle="modal">로그인
            </button>
            ...
            <ul class="breadcrumb">
                <li class="breadcrumb-item active">
                    <button type="button" disabled
                            class="btn btn-success">이용약관
                    </button>
                </li>
                <li class="breadcrumb-item">
                    <button type="button" disabled
                            class="btn btn-light">실명확인
                    </button>
                </li>
                <li class="breadcrumb-item">
                    <button type="button" disabled
...
Copyright © Kakao Corp. All rights reserved.
        ...
        <div  class="card card-body bg-light mt-5 mx-3">
            ...
            <form name="pinfofrm" id="ponfofrm">
                <div class="form-group mt03">
                    <textarea rows="10" class="form-control border-danger">
                        카카오계정 약관
